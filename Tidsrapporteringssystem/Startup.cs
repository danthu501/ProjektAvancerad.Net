...
namespace Tidsrapporteringssystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ITimeReportRepository<Employee>, EmployeeRepository>();
            services.AddScoped<ITimeReportRepository<Project>, ProjectRepository>();
            services.AddScoped<ITimeReportRepository<TimeReport>, TimeReportRepository>();
